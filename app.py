...
if halaman == "🏠 Beranda":
    ...
    st.image("https://www.google.com/url?sa=i&url=https%3A%2F%2Fid.pngtree.com%2Ffree-png-vectors%2Fselamat-datang&psig=AOvVaw3eWoFXrPJotoZ9IzHsrFm2&ust=1752854354303000&source=images&cd=vfe&opi=89978449&ved=0CBIQjRxqFwoTCMDu2LKhxI4DFQAAAAAdAAAAABAE", use_container_width=True)
    # ===============================
